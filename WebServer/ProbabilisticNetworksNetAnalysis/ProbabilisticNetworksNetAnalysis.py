...
class ProbabilisticNetworksNetAnalysisException(Exception):
    def __init__(self, message):
        Exception.__init__(self, message)

class ProbabilisticNetworksNetAnalysis(Task):
    ...
    def __save_task_began(self, user, task_name, directory):
        ...
        self.task.task_type = PROBABILISTIC_NETWORKS_NET_ANALYSIS_TASK
    ...
    def run_task(self):
        try:
            ...
            if len(result.stderr):
                ...
                raise ProbabilisticNetworksNetAnalysisException("Error occurred while computing task: \n\n" + result.stderr)
