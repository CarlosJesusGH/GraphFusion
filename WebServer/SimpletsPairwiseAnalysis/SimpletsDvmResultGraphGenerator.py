...
from .SimpletsPairwiseAnalysisResult import get_all_results
...
class SimpletsDvmResultGraphGenerator:
    ...
    def generate_graph_images(self):
        results = get_all_results(task=self.task, directory=COMPUTATIONS_DIR)
        groupings = []
