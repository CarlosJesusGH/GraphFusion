...
CLUSTERING_ANALYSIS_TASK = "ClusteringAnalysisTask"
ENRICHMENT_ANALYSIS_TASK = "EnrichmentAnalysisTask"
...
CLUSTERING_COMPARISON_SCRIPT = __SCRIPTS_PATH + "clustering_comp_shell_script.sh"
CLUSTERING_ANALYSIS_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
CLUSTERING_ANALYSIS_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
