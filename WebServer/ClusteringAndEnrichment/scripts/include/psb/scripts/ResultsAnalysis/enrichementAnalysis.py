...
def _computePercentages(clusters, annotationsToMolecules, clusterEnrichedAnnotations, clusterEnrichedMolecules):
    ...
    return(annotationsEnriched, clustersEnriched, moleculesEnriched, enrichedClusters)
...
def enrichmentAnalysis(clusters, annotationsToMolecules):
    ...
    annotationsEnriched, clustersEnriched, entitiesEnriched, enrichedClusters = _computePercentages(clusters, annotationsToMolecules, clusterEnrichedAnnotations, clusterEnrichedMolecules)
    
    return annotationsEnriched, clustersEnriched, entitiesEnriched, enrichedClusters

#--------------------------------------------------------------------
#   Enrichment Analysis Genes
#--------------------------------------------------------------------

def enrichmentAnalysisGprofiler(listOfGenes):
    """
