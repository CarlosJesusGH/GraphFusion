...
class GraphletEigencentralitiesException(Exception):
...
class GraphletEigencentralitiesAnalysis(Task):
    ...
    def __save_task_began(self, user, task_name, directory):
        ...
        self.task.task_type = GraphletEigencentralities_TASK
    ...
    def run_task(self):
        try:
            ...
            if len(result.stderr):
                ...
                raise GraphletEigencentralitiesException("Error occurred while computing task: \n\n" + result.stderr)
