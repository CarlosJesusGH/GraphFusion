...
PROBABILISTIC_NETWORKS_MODEL_ANALYSIS_TASK = "ProbabilisticNetworksModelAnalysisTask"
...
PROBABILISTIC_NETWORKS_MODEL_ANALYSIS_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
PROBABILISTIC_NETWORKS_MODEL_ANALYSIS_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
