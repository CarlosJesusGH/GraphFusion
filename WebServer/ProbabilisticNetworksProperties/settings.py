...
PROBABILISTIC_NETWORKS_PROPS_TASK = "ProbabilisticNetworksPropsTask"
...
PROBABILISTIC_NETWORKS_PROPS_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
PROBABILISTIC_NETWORKS_PROPS_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
RESULT_VIEW_FILE = "result.html"
RESULT_FILES = [    "output.txt",
                    "scores.lst",
                    "network_list.txt",
                ]
