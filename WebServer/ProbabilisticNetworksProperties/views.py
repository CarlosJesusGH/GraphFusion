...
# task's own imports
from .ProbabilisticNetworksPropertiesAnalysis import *
from .ProbabilisticNetworksPropertiesResult import *
...
def analysis_page(request):
    context = Context({
        'task_type': PROBABILISTIC_NETWORKS_PROPS_TASK,
    })
    return HttpResponse(get_template("ProbabilisticNetworks/networkProperties/analysis.html").render(context))
...
def submit_analysis_properties(request):
    ...
    rendered_view = get_template("ProbabilisticNetworks/networkProperties/result.html").render(context)
...
def get_view_for_task_other(task, user):
    ...
    return HttpResponse(get_template("ProbabilisticNetworks/networkProperties/result.html").render(context))
