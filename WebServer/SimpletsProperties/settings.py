...
SIMPLETS_PROPERTIES_TASK = "SimpletsPropertiesTask"
...
SIMPLETS_PROPERTIES_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
SIMPLETS_PROPERTIES_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
