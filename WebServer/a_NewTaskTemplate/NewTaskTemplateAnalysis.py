...
class NewTaskTemplateException(Exception):
    def __init__(self, message):
        Exception.__init__(self, message)

class NewTaskTemplateAnalysis(Task):
    ...
    def __save_task_began(self, user, task_name, directory):
        ...
        self.task.task_type = NEWTASKTEMPLATE_TASK
    ...
    def run_task(self):
        try:
            ...
            if len(result.stderr):
                ...
                raise NewTaskTemplateException("Error occurred while computing task: \n\n" + result.stderr)
