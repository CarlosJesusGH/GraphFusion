...
HYPER_GRAPHLETS_PROPS_TASK = "HyperGraphletsPropertiesTask"
...
HYPER_GRAPHLETS_PROPS_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
HYPER_GRAPHLETS_PROPS_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
