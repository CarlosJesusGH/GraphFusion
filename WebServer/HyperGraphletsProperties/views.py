...
# task's own imports
from .HyperGraphletsPropertiesAnalysis import *
from .HyperGraphletsPropertiesResult import *
...
def analysis_page(request):
    context = Context({
        'task_type': HYPER_GRAPHLETS_PROPS_TASK,
    })
    return HttpResponse(get_template("HyperGraphlets/networkProperties/analysis.html").render(context))
...
def submit_analysis_properties(request):
    ...
    rendered_view = get_template("HyperGraphlets/networkProperties/result.html").render(context)
...
def get_view_for_task_other(task, user):
    ...
    return HttpResponse(get_template("HyperGraphlets/networkProperties/result.html").render(context))
