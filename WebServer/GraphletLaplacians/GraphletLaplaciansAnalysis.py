...
class GraphletLaplaciansException(Exception):
    def __init__(self, message):
        Exception.__init__(self, message)

class GraphletLaplaciansAnalysis(Task):
    ...
    def __save_task_began(self, user, task_name, directory):
        ...
        self.task.task_type = GraphletLaplacians_TASK
    ...
    def run_task(self):
        try:
            ...
            if len(result.stderr):
                ...
                raise GraphletLaplaciansException("Error occurred while computing task: \n\n" + result.stderr)
