...
GraphletLaplacians_TASK = "GraphletLaplaciansTask"
...
GraphletLaplacians_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
GraphletLaplacians_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
