...
VISUALIZESE_TASK = "VisualizeSpringEmbTask"
...
VISUALIZESE_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
VISUALIZESE_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
RESULT_VIEW_FILE = "result.html"
RESULT_FILES = ["result*"]    # result_file01.txt, result*, *output*, etc.
REQUEST_FILES = []
