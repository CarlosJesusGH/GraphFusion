...
TOPOLOGICAL_ANALYSIS_TASK = "TopologicalAnalysisTask"
...
TOPOLOGICAL_ANALYSIS_TASK_SCRIPT_IN_FILES = ["input_file1.tmp", "input_file2.tmp"]
TOPOLOGICAL_ANALYSIS_TASK_SCRIPT_OUT_FILES = ["output_file1.tmp", "output_file2.tmp"]
# others
...
DEGREE_DISTRIBUTION_FILE = "Degree_Dist.svg+xml"
